...
extension PopUpMenuVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "PopUpCell") {
...
extension PopUpMenuVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        NavTitle.title = chooseOne[indexPath.row].name
        ...
        if count == 0 {
            ...
            if(chooseOne.count == 0) {
                ...
                NotificationCenter.default.post(name: NSNotification.Name(rawValue: "ThreeCategory") , object: obj, userInfo: nil)
